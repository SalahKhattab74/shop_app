...
class _OnBoardingScreenState extends State<OnBoardingScreen> {
  ...
  List<BoardingModel> boarding = [
    BoardingModel(image: 'assets/images/board1.png',
        title: 'On Board1 Title',
        body: 'On Board1 Title'),
    BoardingModel(image: 'assets/images/board2.png',
        title: 'On Board2 Title',
        body: 'On Board2 Title'),
    BoardingModel(image: 'assets/images/board3.png',
        title: 'On Board3 Title',
        body: 'On Board3 Title')
  ];
  bool isLast = false ;
  void submit(){
